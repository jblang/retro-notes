...
The packet drivers work well with [mTCP](https://www.brutman.com/mTCP/) in DOS. I normally ran the mTCP FTP server on the [PVI-486SP3 system](../../motherboard/Asus-PVI-486SP3/README.md#486dx2-66-system) and then pushed/pulled files using an FTP client on my modern PC. I haven't tried to get IPX or NetBEUI running on it yet.
