...
If your motherboard doesn't have a setting for 6x multi, use the 2x multi since those are coded to run 6x on the K6 2+ and 3+ chips. You also may want to make sure your BIOS is updated to the latest version.
