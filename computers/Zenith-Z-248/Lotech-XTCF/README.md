...
>
>...
>The board is programatically identical to the XT-CF-lite and uses the XT-IDE Universal BIOS, provided through an in-system re-programmable 32KB flash-based ROM. Since the BIOS is only 8KB, 24KB is available for other purposes, and is byte-programmable - the board can therefore function as a universal ROM board.
